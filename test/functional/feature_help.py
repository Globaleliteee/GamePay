...
"""Verify that starting gamepay with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gamepay with -h for help text")
        ...
        self.log.info("Start gamepay with -version for version information")
        ...
        self.log.info("Start gamepayd with -fakearg to make sure it does not start")
