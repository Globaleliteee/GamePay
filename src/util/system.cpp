...
const char * const BITCOIN_CONF_FILENAME = "gamepay.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GamePay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/GamePay";
#else
    // Unix-like
    return pathRet / ".gamepay";
#endif
#endif
}
