...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gamepay-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gamepay-tx [options] <hex-tx> [commands]  Update hex-encoded gamepay transaction\n" +
            "or:     gamepay-tx [options] -create [commands]   Create hex-encoded gamepay transaction\n" +
            "\n";
