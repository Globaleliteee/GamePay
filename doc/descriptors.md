# Support for Output Descriptors in GamePay Core

Since GamePay Core v0.17, there is support for Output Descriptors. This is a
...
existing GamePay Core wallets, a convenience function `combo` is
