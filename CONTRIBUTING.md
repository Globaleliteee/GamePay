Contributing to GamePay Core
============================

The GamePay Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the GamePay Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/gamepay-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to gamepay-qt
...
The following applies to code changes to the GamePay Core project (and related
projects such as libsecp256k1), and is not to be confused with overall GamePay
Network Protocol consensus changes.

Whether a pull request is merged into GamePay Core rests with the project merge
...
Patches that change GamePay consensus rules are considerably more involved than
...
Where a patch set proposes to change the GamePay consensus, it must have been
...
The project leader is the release manager for each GamePay Core release.
